...
<?php
//index.php phpmailer when using contact form
...
if(isset($_POST["submit"]))
{
 ...
 if(empty($_POST["file"]))
 {
  $error .= '<p><label class="text-danger">file not loaded</label></p>';
 }
 else
 {
  $file = clean_text($_POST["file"]);
 }
 if($error == '')
 {
  ...
  $mail->AddAddress('efefbi@yahoo.com', 'Name');//Adds a "To" address
     ...
     <form method="post">
	  ...
	  <div class="form-group">
       <label>load file</label>
        <input type="file" multiple ="false" accept = "image/*" id="fileInput" name="file" class="form-control" " value="<?php echo $file; ?>" />
      </div>
